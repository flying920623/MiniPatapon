...
public class ParaBackgroundLevel3 extends ParaBackground {
	...
	public TextureRegion bg1 = ResourceLoader.getRegionFromPacker(TextureAssets.Level1Layer1Img);
	public TextureRegion bg2 = ResourceLoader.getRegionFromPacker(TextureAssets.Level1Layer2Img);
	public TextureRegion bg3 = ResourceLoader.getRegionFromPacker(TextureAssets.Level1Layer3Img);
	public TextureRegion bg4 = ResourceLoader.getRegionFromPacker(TextureAssets.Level1Layer4Img);
	public TextureRegion bg5 = ResourceLoader.getRegionFromPacker(TextureAssets.Level1Layer5Img);
...
//		.start(tweenManager);
	...
	public void render() {
//		DefaultLogger.getDefaultLogger().logWithSignature(this, "render");
